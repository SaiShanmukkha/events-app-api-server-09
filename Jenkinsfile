    ...
    stages {
        stage('Stage 1') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://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@github.com/SaiShanmukkha/events-app-api-server-09.git'
        ...
        stage('Stage 2') {
         ...
         stage('Stage 5') {
            steps {
                ...
                sh 'gcloud container clusters get-credentials cluster-1 --zone us-central1-c --project $GOOGLE_CLOUD_PROJECT'
